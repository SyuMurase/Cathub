...
//   List<String> _namelist = ['お金', 'プログラミング','プログラマー', '旅・車・バイク', 'エンジニア', 'swift','Typescript','javascript'];
...
//               decoration: InputDecoration(hintText: 'serch..',contentPadding: EdgeInsets.symmetric(horizontal: 16)),
//             ),
//             const SizedBox(height: 50),
